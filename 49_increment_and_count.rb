...
# Given an integer count, increment the same by 1 and add it to the present count value.
# Continue the same till count value reaches maximum count. The method should return the final sum.
...
p increment_count(count, maximum_count)
